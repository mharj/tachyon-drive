...
export class FileUpdateNotify extends EventEmitter<ExternalNotifyEventsMap> implements IExternalNotify {
	...
	public constructor(fileName: Loadable<string>, logger?: ILoggerLike) {
		super();
	...
	public async init(): Promise<void> {
		...
		this.logger?.debug(`FileUpdateNotify: init ${fileName}`);
	...
	public async unload(): Promise<void> {
		const fileName = await this.getFileName();
		this.logger?.debug(`FileUpdateNotify: unload ${fileName}`);
